            ...
            <div className="grid md:grid-cols-1 mt-[2rem] bg-white min-h-screen">
                <div className="container mx-auto">
                    <div className="text-center">
                        <h4 className="font-poppins text-[#121212] text-[20px] md:text-[38px]">
                            Contact Us
                        </h4>
                        ...
                        <div className="bg-[#ececec] rounded-md mb-[2rem]">
                            <div className="grid md:grid-cols-3">
                                <div className="col-span-1 bg-contactBackground h-auto rounded-md pl-[2rem] py-[1rem] hidden sm:hidden md:block">
                                    ...
                                    <p className="font-poppins text-[20px] mt-[2rem] text-[#778899]">Contact Information</p>
                                    ...
                                    <div className="mt-[3rem]">
                                        <div className="flex gap-5">
                                            ...
                                            <p className="font-poppins font-normal text-[14px] text-center text-[#778899] md:mt-1">+254711223344</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-[3rem]">
                                        <div className="flex gap-5">
                                            ...
                                            <p className="font-poppins font-normal text-[14px] text-center text-[#778899] md:mt-1">tafsiri.ai@gmail.com</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-[3rem]">
                                        <div className="flex gap-5">
                                            ...
                                            <p className="font-poppins font-normal text-[14px] text-center text-[#778899] md:mt-1">Nairobi, Kenya.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-2 mt-[12rem] mb-[1rem] ">
                                        <div className="flex gap-5">
                                            <div className="bg-[#cd853f] w-[32px] h-[32px] rounded-full">
                                    ...
                                    <form>
                                        <div className=" h-11 w-full mt-2">
                                            <input placeholder="Enter your Name *"
                                                   className="peer h-full w-full border-b border-[#cd853f] bg-transparent pt-4 pb-1.5 font-baloo text-sm font-normal text-black outline outline-0 transition-all placeholder-shown:border-[#707070] focus:border-gray-900 focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"/>
                                        </div>
                                        ...
                                        <div className="flex justify-end">
                                            <button
                                                className="mt-[3rem] w-[165px] h-[49px] all-[unset] bg-[#cd853f] rounded-md box-border font-poppins font-normal text-white text-[15px] tracking-[0] leading-[28.5px]">
                                                Send Message
                                            </button>
                                        </div>
                                    </form>
