    ...
    return (
        <nav className="container mx-auto bg-white border-gray-200">
            <div className="flex flex-wrap items-center justify-between py-4">
                <div className="flex">
                    <img className="flex items-center space-x-3 rtl:space-x-reverse h-16 cursor-pointer" alt="Logo" src={Logo} />
                    <p className="font-normal font-poppins py-4">TafsiriAI</p>
                </div>
                ...
                <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1"
                    ...
                    <ul className="flex flex-col font-normal p-4 md:p-0 mt-2 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li className="block py-2 px-3 md:p-0 font-poppins font-normal text-[14px]">
                            <NavLink
                                to="/"
