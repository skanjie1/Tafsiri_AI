...
const WebcamComponent = () => {
    ...
    const handleSpeech = () => {
        const utterance = new SpeechSynthesisUtterance(mode === 'short' ? sign : translations.join(' '));
                ...
                <div className="translation-output flex flex-col items-center sm:items-start">
                    <div className="mt-[1rem] mx-auto sm:justify-start">
                        ...
                        <div className="flex items-center mt-4">
                            ...
                            <select
                                className="bg-gray-200 text-[#21383E] text-poppins border border-gray-300 rounded-full py-2 px-2"
                                value={mode}
                                onChange={(e) => setMode(e.target.value)}
                            >
                                <option className="font-poppins text-[14px]" value="short">Short Structure</option>
                                <option className="font-poppins text-[14px]" value="sentence">Sentence</option>
                            </select>
                        </div>
